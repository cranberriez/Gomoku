...
public class checks
{
	...
	public boolean checkWin(int[][] board, int player, int x, int y) //goes through and checks every win combination
	{
		...
		{
			total++;
			if (x > 1 && board[x-2][y] == player) //to the left of the piece
			{
				total++;
				if (x > 2 && board[x-3][y] == player) //to the left of the piece
				{
					total++;
					if (x > 3 && board[x-4][y] == player) //to the left of the piece
					{
						total++;
					}
				}
		...
		if (x < 14 && board[x+1][y] == player) //to the right of the piece
		{
			total++;
		...
		{
			total++;
			if (y > 1 && board[x][y-2] == player) //to the left of the piece
			{
				total++;
				if (y > 2 && board[x][y-3] == player) //to the left of the piece
				{
					total++;
					if (y > 3 && board[x][y-4] == player) //to the left of the piece
					{
						total++;
					}
				}
		...
		if (y < 14 && board[x][y+1] == player) //to the right of the piece
		{
			total++;
		...
		{
			total++;
			if (x > 1 && y > 1 && board[x-2][y-2] == player) //to the left of the piece
			{
				total++;
				if (x > 2 && y > 2 && board[x-3][y-3] == player) //to the left of the piece
				{
					total++;
					if (x > 3 && y > 3 && board[x-4][y-4] == player) //to the left of the piece
					{
						total++;
					}
				}
		...
		if (x < 14 && y < 14 && board[x+1][y+1] == player) //to the right of the piece
		{
			total++;
		...
		{
			total++;
			if (x < 13 && y > 1 && board[x+2][y-2] == player) //to the left of the piece
			{
				total++;
				if (x < 12 && y > 2 && board[x+3][y-3] == player) //to the left of the piece
				{
					total++;
					if (x < 11 && y > 3 && board[x+4][y-4] == player) //to the left of the piece
					{
						total++;
					}
				}
		...
		if (x > 0 && y < 14 && board[x-1][y+1] == player) //to the right of the piece
		{
			total++;
